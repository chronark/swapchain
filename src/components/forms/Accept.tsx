          ...
          <div className="flex flex-col mt-12 space-y-10">
            ...
            <section>
              ...
              <p className="px-4 mx-auto mt-2 text-sm text-center text-gray-500">
                Your public Bitcoin key and Bitshares account name can be calculated from your private key. Your private
                keys will never leave your browser, it is only used to sign your transactions.{" "}
            ...
            <section>
              <div className="block">
                ...
                <Input
                  ...
                  onChange={updateField}
                  type="text"
                  placeholder="Please enter the hash you received from your trading partner"
                ></Input>
              </div>
            </section>
            <section>
              ...
              <div className="mt-4">
                ...
                <p className="px-4 mx-auto mt-2 text-sm text-center text-gray-500">
                  By design one block should equal 10 minutes. However it can differ quite a lot in reality. Please make
                  sure you enter the same value as your trading partner.
                </p>
              </div>
            </section>
