...
export const Propose = () => {
  ...
  /**
   * Copy all relevant information from the propser to the user's clipboard
   */
  const copyAll = (): void => {
    const str = `
                    Your secret hash:
      ...
      <div className="flex flex-col mt-12 space-y-10">
        ...
        <section>
          ...
          <div className="items-center justify-between mt-4 md:space-x-4 md:flex">
            ...
            <div className="flex-grow">
              ...
              <div className="relative">
                <span className="absolute inset-y-0 right-0 flex items-center mr-6 text-sm text-gray-600">
                  {fields.currencyToGive === Currency.BTC ? Currency.BTS : Currency.BTC}{" "}
                </span>
        ...
        <section>
          ...
          <div className="flex flex-col space-y-4">
            <div className="items-center justify-between mt-4 md:space-x-2 md:flex">
    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div>
        ...
        <section className="px-3 py-2">
          ...
          <p className="p-3 font-mono text-center text-teal-900 break-all border border-teal-400 rounded">
            {state === State.RUNNING ? toPublicKey(fields.bitcoinPrivateKey) : ""}
          </p>
        </section>
      </div>
    </div>
