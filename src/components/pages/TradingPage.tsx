    ...
    <div className="flex flex-col items-center justify-between mt-12 space-y-8 rounded md:space-x-8 md:flex-row md:space-y-0">
      <div className="flex-grow">
        ...
        <p className="mt-4 leading-7 text-gray-500">
          Even more Explanation Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis
      ...
      <Form
        ...
        footer={
          <Link
            ...
            className="px-8 py-3 text-gray-900 uppercase transition duration-200 ease-in-out bg-white border rounded-sm shadow-sm focus:outline-none hover:border-teal-500 hover:bg-white"
          >
            Start
          </Link>
        }
