...
describe("Test if orders are sent to our database and respectively saved", () => {
    it("should reply to POST with 400 if it fails to send orders to the database", async () => {
        ...
        .post("/orderbook")
        .send({ address: "0123456789", timelock: 5, txFees: 5000, bidType: "BTC", askType: "BTS", bidAmount: 1, askAmount: 10000, expiryDate: "01/09/2020" })
    ...
    it("should reply to POST with 200 if the request is valid", async () => {
        ...
        const body = { address: "0123456789", timelock: 5, txFees: 5000, bidType: "BTC", askType: "BTS", bidAmount: 1, askAmount: 10000, expiryDate: "01/09/2020" }
