...
export async function getUserInput(): Promise<ACCSFields> {
  ...
  const amount = await askUser(`Please enter the amount of ${txTypeName.slice(-3)} you want to exchange: `)
  ...
  if (fields.mode === "proposer") {
    timelock = await askUser("Please enter the duration of the timelock (0 = long, 1 = medium, 2 = short): ")
