...
export const Accept = () => {
    ...
    const submitHandler = () => {
        ...
        config.keyPairCompressedBTC.privateKey = Buffer.from(fields.bitcoinPrivateKey)
        config.privateKeyBTS = fields.bitsharesPrivateKey
        config.keyPairCounterpartyCompressedBTC.publicKey = Buffer.from(fields.counterpartyBitcoinPublicKey)
        config.accountCounterpartyBTS = fields.bitsharesAccountName
        config.secret.hash = Buffer.from(fields.hash)
