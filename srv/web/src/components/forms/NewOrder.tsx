...
export const NewOrder = () => {
    ...
    return (
        ...
        <section className="mt-12 md:space-x-4 md:flex">
        ...
        <section className="mt-24 md:space-x-4 md:flex">
            ...
            <div className=" md:w-1/2">
                ...
                <div className="relative">
                    <span className="absolute inset-y-0 right-0 flex items-center mr-6 text-sm text-gray-600">
                        Blocks          </span>
                    <Input min={6} max={20} name="timelockDuration" value={fields.timelockDuration} onChange={updateField} type="number" placeholder="6"></Input>
                </div>
            </div>
            <div className="mt-4 md:w-1/2 md:mt-0">
                ...
                <div className="relative">
                    <span className="absolute inset-y-0 right-0 flex items-center mr-6 text-sm text-gray-600">
                        Days</span>
                    <Input min={1} max={7} name="orderDuration" value={fields.orderDuration} onChange={updateField} type="number" placeholder="how long your order will stay active"></Input>
                </div>
            </div>
        </section>
