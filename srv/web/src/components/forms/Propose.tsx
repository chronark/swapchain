...
export const Propose = () => {
    ...
    */
    ...
    const formFields = <div className="flex flex-col mt-12 space-y-10">
        <section>
    ...
    const running = <div className="flex flex-col items-center justify-center">
        ...
        <div>
            ...
            <section className="px-3 py-2">
                ...
                <p className="p-3 font-mono font-bold text-center text-teal-900 break-all border border-teal-400 rounded">{Timelock[fields.timelock]}</p>
            </section>
        </div>
    </div>
