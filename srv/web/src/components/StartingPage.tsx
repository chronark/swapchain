...
import swapchain_gif from './components/assets/swapchain_gif.gif'
...
export default () => {
  ...
  <span className="block bg-green-500 p-10">
        ...
        <div className="block w-full px-3 mb-6">
            ...
            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="swapchain_mockup@gmail.com"></input>
          </div>
